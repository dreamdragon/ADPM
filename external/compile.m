...
if nargin < 3
  ...
  eval([mexcmd ' external/features/resize.cc']);
  eval([mexcmd ' external/features/features.cc']);
  %eval([mexcmd ' gdetect/dt.cc']);
  %eval([mexcmd ' gdetect/bounded_dt.cc']);
  %eval([mexcmd ' gdetect/get_detection_trees.cc']);
  eval([mexcmd ' external/gdetect/compute_overlap.cc']);
  ...
  eval([mexcmd ' external/gdetect/fconv_var_dim_MT.cc -o fconv_var_dim']);
